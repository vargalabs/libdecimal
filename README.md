...
| Platform | Package |
|----------|---------|
| Debian / Ubuntu (amd64) | `libdecimal-<version>-Linux-amd64.deb` |
| Red Hat / Fedora (x86_64) | `libdecimal-<version>-Linux-x86_64.rpm` |
| macOS (x86_64) | `libdecimal-<version>-macOS-x86_64.pkg` |
| Windows (x64) | `libdecimal-<version>-Windows-x64.exe` |
